...
contract LotteryGas is AccessControl, VRFConsumerBase, ReentrancyGuard {
    ...
    uint256 public lastRequested = type(uint256).max - 1;
    uint256 public lastFulfilled = type(uint256).max - 1;
